...
def noisify_pairflip(y_train, noise, random_state=None, nb_classes=78):
    """mistakes:
        flip in the pair
    """
    P = np.eye(nb_classes)
    ...
    if n > 0.0:
        ...
        print('Actual noise %.6f' % actual_noise)
...
def noisify(nb_classes=78, train_labels=None, noise_type=None, noise_rate=0, random_state=0):
