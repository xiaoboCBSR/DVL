...
if __name__ == "__main__":
    ...
    # default settings
    p.add('--margin', type=float, default=0.05, help='margin for margin-based losses')
    p.add('--decisive_margin', type=float, default=0.05, help='decisive margin to indicate decisive vectors')
    p.add('--scale', type=int, default=32, help='scale')

    # decisive vector learning
    p.add('--fc_type', type=str_or_none, default=None, help='type of fc layer: NL or DVL')
    p.add('--t', type=float, default=0.0, help='weights of DVL')
    ...
    if args.mode == 'train':
        ...
        print("Saving model...")
        torch.save({'state_dict': classifier.state_dict()}, join(logging_path, "{}_{}_{}_{}_model.pt".
                                                                 format(fc_type, noise_type, noise_rate, t)))
