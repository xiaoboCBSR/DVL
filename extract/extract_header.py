...
import itertools
from extract.helpers.utils import canonical_header, long_name_digest
from tqdm import tqdm
from utils import get_valid_types, str_or_none, str2bool

from extract.helpers.read_raw_data import get_dfs_by_corpus
...
parser.add_argument('--file_size', type=int, default=40000, help='number of tables in a file')
parser.add_argument('--file_number', type=int, default=1, help='number of files to generate')
